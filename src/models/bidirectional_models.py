...
class UniModel(nn.Module):
    def __init__(self, time_emb_size=128):
        super().__init__()
...
class BiModel(nn.Module):
    def __init__(self, time_emb_size=128):
        ...
        self.model_f = UniModel(time_emb_size=self.time_emb_size)
        self.model_b = UniModel(time_emb_size=self.time_emb_size)
